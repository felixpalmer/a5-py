...
def vector_difference_np(A: Cartesian, B: Cartesian) -> float:
    """
...
def triple_product_np(A: Cartesian, B: Cartesian, C: Cartesian) -> float:
    """
...
def quadruple_product_np(A: Cartesian, B: Cartesian, C: Cartesian, D: Cartesian) -> Cartesian:
    """
    Computes the quadruple product of four vectors using numpy operations
...
def slerp_np(A: Cartesian, B: Cartesian, t: float) -> Cartesian:
    """
    Spherical linear interpolation between two vectors using numpy
